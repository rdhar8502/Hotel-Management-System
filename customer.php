...
<body style="background-image: url('image/hotel-family-1.jpg');background-repeat: no-repeat;
            ...
            <div class="panel panel-default" style="opacity:0.8">
                ...
                <div class="panel-body" style="opacity:1.0">
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="rooms">
                        ...
                        <tbody>
                        <?php
                        $customer_query = "SELECT * FROM `customer` NATURAL JOIN `id_card_type`";
                        ...
                        if (mysqli_num_rows($customer_result) > 0) {
                            ...
                            while ($customer = mysqli_fetch_assoc($customer_result)) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $customer['id_card_type'] ?></td>
